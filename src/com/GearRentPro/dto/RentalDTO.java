// src/com/GearRentPro/dto/RentalDTO.java
package com.GearRentPro.dto;

import java.sql.Date;

public class RentalDTO extends SuperDTO {
    ...
    // Constructor with 18 parameters matching your Rental entity
    public RentalDTO(String rentalId, String equipmentId, String customerId, 
    ...
    public String toString() {
        return "RentalDTO{" + "rentalId='" + rentalId + '\'' + ", equipmentId='" + equipmentId + '\'' + 
