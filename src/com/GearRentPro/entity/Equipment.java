// Equipment.java - Add the missing date fields
...
public class Equipment implements SuperEntity {
    ...
    private LocalDate addedDate;           // Add this
    private LocalDate lastMaintenanceDate; // Add this
    
    public Equipment() {}
    
    // Updated constructor with 11 parameters
    public Equipment(String equipmentId, String categoryId, String brand, 
    ...
    public LocalDate getAddedDate() { return addedDate; }  // Add this
    public void setAddedDate(LocalDate addedDate) { this.addedDate = addedDate; }
    
    public LocalDate getLastMaintenanceDate() { return lastMaintenanceDate; }  // Add this
    public void setLastMaintenanceDate(LocalDate lastMaintenanceDate) { this.lastMaintenanceDate = lastMaintenanceDate; }
    
    @Override
    public String toString() {
        return "Equipment{" + "equipmentId=" + equipmentId + ", brand=" + brand + 
